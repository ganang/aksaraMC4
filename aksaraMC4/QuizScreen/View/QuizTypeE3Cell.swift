...
//        button.layer.applySketchShadow(color: UIColor.init(displayP3Red: 54/255, green: 159/255, blue: 255/255, alpha: 1), alpha: 0.15, x: 0, y: 8, blur: 12, spread: 0)
    ...
    func setupConstraint() {
        ...
        placeholderCarakanC.centerYAnchor.constraint(equalTo: centerYAnchor, constant: -42).isActive = true
        ...
        questionPlaceholder3.centerYAnchor.constraint(equalTo: centerYAnchor, constant: -42).isActive = true
