...
class QuizViewTypeE3: UIViewController, UIGestureRecognizerDelegate {
    ...
    func setupInterfaceComponent() {
        ...
        view.addSubview(placeholderCarakanC)
        
        view.addSubview(questionLabel)
        view.addSubview(headerCarakanALabel)
        view.addSubview(headerCarakanBLabel)
        view.addSubview(footerPlaceholderCarakanA)
        view.addSubview(footerPlaceholderCarakanB)
        view.addSubview(footerPlaceholderCarakanC)
        ...
        view.addSubview(questionPlaceholder3)
        view.addSubview(aksaraLabel1)
        view.addSubview(aksaraLabel2)
        view.addSubview(aksaraLabel3)
    ...
    func setupConstraint() {
        ...
        centerPlaceHolderConstraint =  placeholderCarakanA.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -116)
        ...
        placeholderCarakanC.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        ...
        questionPlaceholder3.trailingAnchor.constraint(equalTo: view.centerXAnchor, constant: -120).isActive = true
        questionPlaceholder3.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
